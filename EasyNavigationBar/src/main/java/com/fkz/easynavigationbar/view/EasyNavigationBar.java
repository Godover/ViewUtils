package com.fkz.easynavigationbar.view;
...
import com.fkz.easynavigationbar.R;
import com.fkz.easynavigationbar.adapter.ViewPagerAdapter;
import com.fkz.easynavigationbar.utils.NavigationUtil;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    private static final String TAG = "EasyNavigationBar";
    //红点集合
...
//要放在前面
            ...
            msgPointTop = attributes.getDimension(R.styleable.EasyNavigationBar_Easy_msgPointTop, -iconSize * 3.0f / 5);
            hintPointTop = attributes.getDimension(R.styleable.EasyNavigationBar_Easy_hintPointTop, hintPointTop);

            msgPointLeft = attributes.getDimension(R.styleable.EasyNavigationBar_Easy_msgPointLeft, -iconSize / 2.0f);
...
//        anim = null;
    ...
    public void updateNavigationIcon(int position, boolean isNormal, int res) {
        if (isNormal) {
            if (normalIconItems == null | position >= normalIconItems.length) {
                return;
            }
            normalIconItems[position] = res;
        } else {
            if (selectIconItems == null | position >= selectIconItems.length) {
                return;
            }
    ...
    private void setViewPagerAdapter() {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            @Override
            public void onPageSelected(int position) {
                post(() -> selectTab(position, smoothScroll, false));
            }
    ...
    public void selectTab(int position, boolean smoothScroll, boolean selectPager) {
        if (currentPosition == position || position >= imageViewList.size() || position < 0) {
            return;
        }
...
//    }
    ...
    public String toString() {
        return "EasyNavigationBar{" +
                ...
                ", lineView=" + lineView +
                ", hintPointList=" + hintPointList +
                ", msgPointList=" + msgPointList +
                ", imageViewList=" + imageViewList +
                ", textViewList=" + textViewList +
                ", tabList=" + tabList +
                ", mViewPager=" + mViewPager +
                ", mViewPager2=" + mViewPager2 +
                ", addViewLayout=" + addViewLayout +
                ", titleItems=" + Arrays.toString(titleItems) +
                ", normalIconItems=" + Arrays.toString(normalIconItems) +
                ", selectIconItems=" + Arrays.toString(selectIconItems) +
                ", fragmentList=" + fragmentList +
                ", fragmentManager=" + fragmentManager +
                ", smoothScroll=" + smoothScroll +
                ", iconSize=" + iconSize +
                ", hintPointSize=" + hintPointSize +
                ", hintPointLeft=" + hintPointLeft +
                ", hintPointTop=" + hintPointTop +
                ", onTabClickListener=" + onTabClickListener +
                ", onCenterTabClickListener=" + onCenterTabClickListener +
                ", onTabLoadListener=" + onTabLoadListener +
                ", msgPointTextSize=" + msgPointTextSize +
                ", msgPointSize=" + msgPointSize +
                ", msgPointMoreWidth=" + msgPointMoreWidth +
                ", msgPointMoreHeight=" + msgPointMoreHeight +
                ", msgPointMoreRadius=" + msgPointMoreRadius +
                ", msgPointColor=" + msgPointColor +
                ", msgPointLeft=" + msgPointLeft +
                ", msgPointTop=" + msgPointTop +
                ", tabTextTop=" + tabTextTop +
                ...
                ", centerLayoutHeight=" + centerLayoutHeight +
                ", centerLayoutBottomMargin=" + centerLayoutBottomMargin +
                ", centerLayoutRule=" + centerLayoutRule +
                ", hasPadding=" + hasPadding +
                ", mode=" + mode +
                ", centerAsFragment=" + centerAsFragment +
                ", customAddView=" + customAddView +
                ", centerTextSize=" + centerTextSize +
                ", centerNormalTextColor=" + centerNormalTextColor +
                ", centerSelectTextColor=" + centerSelectTextColor +
                ", centerTextTopMargin=" + centerTextTopMargin +
                ", centerAlignBottom=" + centerAlignBottom +
                ", centerImage=" + centerImage +
                ", empty_line=" + empty_line +
                ", contentType=" + contentType +
                ", centerImageRes=" + centerImageRes +
                ", centerTextStr='" + centerTextStr + '\'' +
                ", onlyNavigation=" + onlyNavigation +
                ", currentPosition=" + currentPosition +
                ", tabContentRule=" + tabContentRule +
                ", tabContentBottomMargin=" + tabContentBottomMargin +
                ", textSizeType=" + textSizeType +
                ", isViewPager2=" + isViewPager2 +
                '}';
    }
